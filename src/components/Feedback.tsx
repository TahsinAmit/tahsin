  ...
  return (
    <form id="feedbackForm">
      <div className="form-group">
        ...
        <label>
          <input type="radio" name="trustworthy" defaultValue={1} /> Strongly Disagree
        </label>
        <label>
          <input type="radio" name="trustworthy" defaultValue={2} /> Disagree
        </label>
        <label>
          <input type="radio" name="trustworthy" defaultValue={3} /> Neither Agree nor Disagree
        </label>
        <label>
      ...
      <div className="form-group">
        ...
        <label>
          <input type="radio" name="sourceInfluence" defaultValue={1} /> Strongly Disagree
        </label>
        <label>
          <input type="radio" name="sourceInfluence" defaultValue={2} /> Disagree
        </label>
        <label>
          <input type="radio" name="sourceInfluence" defaultValue={3} /> Neither Agree nor Disagree
        </label>
        <label>
          <input type="radio" name="sourceInfluence" defaultValue={4} /> Agree
        </label>
        <label>
          <input type="radio" name="sourceInfluence" defaultValue={5} /> Strongly Agree
        </label>
      </div>
      ...
      <div className="form-group">
        ...
        <label>
          <input type="radio" name="futureTrust" defaultValue={1} /> Strongly Disagree
        </label>
        <label>
          <input type="radio" name="futureTrust" defaultValue={2} /> Disagree
        </label>
        <label>
          <input type="radio" name="futureTrust" defaultValue={3} /> Neither Agree nor Disagree
        </label>
        <label>
